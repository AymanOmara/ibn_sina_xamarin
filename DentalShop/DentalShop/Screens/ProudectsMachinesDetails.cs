...
{
    public class ProudectsMachinesDetails
    {
        int w;
        int h;
        ...
        public ProudectsMachinesDetails(int w, int h, HomePage home)
        {
        ...
        public void SetData()
        {
            LBBrief.Text = prouductDetails.Size;
