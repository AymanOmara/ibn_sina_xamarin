...
namespace DentalShop
{
    public class ProuductPage
    {
        ...
        public string Type = "";
        public GetProuduct getProuduct = new GetProuduct();
        ...
        public ProuductPage(int w, int h, HomePage home)
        {
        ...
        public void InitializeComponents()
        {
            ...
            SBSearch.SearchButtonPressed += SBSearch_SearchButtonPressedAsync;
            ...
            LBItemNumber.WidthRequest = ImgItemNumer.WidthRequest / 2 + 2;
            LBItemNumber.HeightRequest = ImgItemNumer.HeightRequest / 2 + 2;
            LBItemNumber.TextColor = LabelColor;
            LBItemNumber.FontSize = FontSize - 5;
            LBItemNumber.Text = "0";
            Point LItemNumberLocation = new Point(width - ImgCar.WidthRequest - (ImgItemNumer.WidthRequest / 1.5) + 10, ypoint + 3);
            ...
            Container.Children.Add(AILoading, new Point(w / 2 - AILoading.WidthRequest / 2, h / 2 - AILoading.HeightRequest / 2 - 50));
        ...
        private async void SBSearch_SearchButtonPressedAsync(object sender, EventArgs e)
        {
            if (SBSearch.Text == "")
                return;
            if (!IsBusy)
        ...
        //    count++;
        //    await Settings.prouductPage.GetDataAsync();
        //    AILoading.IsRunning = false;
        //}
        ...
        private async void Scroll_Scrolled(object sender, ScrolledEventArgs e)
        {
                ...
                scrollView.ScrollY >= scrollView.ContentSize.Height - scrollView.Height - 50)
            {
                try
                {
                    ...
                    AILoading.IsRunning = true;
                    count++;
                    await LoadMoreSet(); // Use LoadMoreSet instead of GetDataAsync
                }
                finally
                {
                    isLoading = false;
        ...
        {
            if (Settings.prouductPage.Type=="Devices")
            {
                home.Content = Settings.proudectDeivceDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Correction")
            {
                home.Content = Settings.prouductCorrectionDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Materials")
            {
                home.Content = Settings.proudectMaterialsDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Equipment")
            {
                home.Content = Settings.proudectEquipmentDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Machines")
            {
                home.Content = Settings.proudectsMachinesDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Student")
            {
                home.Content = Settings.proudectStudentDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Clothes")
            {
                home.Content = Settings.ClothesDetails.MainLayout;
            }
            else if (Settings.prouductPage.Type == "Files")
            {
                home.Content = Settings.FilesDetails.MainLayout;
            }
        }
        ...
        public async System.Threading.Tasks.Task GetDataAsync()
        {
            LVProudect.Children.Clear();
            LVProudect2.Children.Clear();
            LBNoData.IsVisible = false;
            ...
            if (Alpha)
            {
                prouductEntity = await Settings.GetAlphaProuductAsync(getProuduct);
                Alpha = false;
            }
            else
                prouductEntity = await Settings.GetProuductAsync(getProuduct);
        ...
        public async System.Threading.Tasks.Task SetDataAsync()
        {
            ...
            {
                LBTop.Text = "الأجهزة";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_4.png");
            ...
            {
                LBTop.Text = "التقويم";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_6.png");
                getProuduct.Type = Type;
                getProuduct.SearchText = "";
            }
            else if (Type == "Equipment")
            {
                LBTop.Text = "التجهيزات";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_5.png");
                getProuduct.Type = Type;
                getProuduct.SearchText = "";
            }
            ...
            {
                LBTop.Text = "الآلات";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_3.png");
                getProuduct.Type = Type; ;
                getProuduct.SearchText = "";
            }
            ...
            {
                LBTop.Text = "الخامات";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_2.png");
                getProuduct.Type = Type ;
                getProuduct.SearchText = "";
            }
            else if (Type == "Clothes")
            {
                LBTop.Text = "ملابس طبيه";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_7.png");
                getProuduct.Type = Type;
                getProuduct.SearchText = "";
            }
            else if (Type == "Files")
            {
                LBTop.Text = "فايلات وبير";
                ImgTitle.Source = ImageSource.FromResource("DentalShop.Images.Title_8.png");
                getProuduct.Type = Type;
                getProuduct.SearchText = "";
            }
            await GetDataAsync();
