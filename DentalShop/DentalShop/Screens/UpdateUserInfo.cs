...
namespace DentalShop
{
    public class UpdateUserInfo
    {
        ...
        public UpdateUserInfo(int w, int h, HomePage home)
        {
        ...
        public void InitializeComponents()
        {
            ...
            LBTop.HeightRequest = Labelheight;
            LBTop.FontSize = FontSize;
            LBTop.Text = "اعدادات الحساب";
            ...
            double ypoint = LBTop.HeightRequest * 2 + 20;
            ...
            ImgUserPhoto.WidthRequest = Labelheight * 6;
            ImgUserPhoto.HeightRequest = Labelheight * 6;
            ...
            ImgUserIcon.WidthRequest = Labelheight + 5;
            ImgUserIcon.HeightRequest = Labelheight + 5;
            ...
            ImgEyePassword.WidthRequest = Labelheight + 5;
            ImgEyePassword.HeightRequest = (Labelheight + 5) * 0.61;
            ...
            ImgUserPassword2.WidthRequest = Labelheight + 5;
            ImgUserPassword2.HeightRequest = Labelheight + 5;
            ...
            ImgUserPhone.WidthRequest = Labelheight + 5;
            ImgUserPhone.HeightRequest = Labelheight + 5;
            ...
            //button
            LBButton = new Label();
            LBButton.WidthRequest = w/4;
            LBButton.TextColor = Color.White;
            LBButton.HeightRequest = Labelheight;
            ...
            Container.Children.Add(LBButton, new Point(w/2-LBButton.WidthRequest/2, ypoint + 10));
        ...
        public async System.Threading.Tasks.Task ImgUserPhotoClickAsync()
        {
            Settings.imageCropper.Type = "Update";
            try
            {
        ...
        public async Task UpdateAccount()
        {
            ...
            if (goodData && ready1)
            {
                ...
                try
                {
                    ...
                    var ServerResult = await Settings.HttpClient.PostAsync(new Uri(Settings.WebServiceUrl + "/UpdateAccountInfo"), content);
                    ...
                    MyObject = JsonConvert.DeserializeObject<UserEntity>(json);
                    Settings.cash.UserInfo = MyObject;
                    Settings.SaveCash();
                    Settings.updateUserInfo.UserInfo = MyObject;
                    ...
                    {
                        Settings.Message = "تم نعديل بيانات الحساب بنجاح";
                        ClearData();
                    }
                    if (Response == "not")
                    {
        ...
        public  void SetData()
        {
            ...
            ImgUserPhoto.Source = UserInfo.UserPhoto;
            EUserName.Text = UserInfo.UserName;
            EEmail.Text = UserInfo.UserEmail;
            EPassword.Text = EPassword2.Text = UserInfo.UserPassword;
            EPhone.Text = UserInfo.UserPhone;
        }
    }
}
